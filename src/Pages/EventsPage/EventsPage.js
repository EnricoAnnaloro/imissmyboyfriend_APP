                ...
                <div className="EventsPage__eventsContainer">
                    <div className="EventsPage__EventsSubContainer">
                        <h3 className="EventsPage__EventsTitle">
                            <FontAwesomeIcon icon={faExclamation} /><span style={{ margin: "0 10px" }}>Special Events</span><FontAwesomeIcon icon={faExclamation} />
                        </h3>
                        {specialEventsDisplayed}
                    </div>
                    <div className="EventsPage__EventsSubContainer">
                        <h3 className="EventsPage__EventsTitle">
                            <FontAwesomeIcon icon={faKissWinkHeart} /><span style={{ margin: "0 10px" }}>Daily Events</span><FontAwesomeIcon icon={faKissWinkHeart} />
                        </h3>
